...
const COLORS = [
  '#38bdf8', // blue-400 (Large Cap)
  '#fbbf24', // orange-400 (Mid Cap)
  '#f87171', // red-400 (Small Cap)
  '#a78bfa', // purple-400 (Unknown)
];

function formatData(dataObj) {
  if (!dataObj) return [];
  return Object.entries(dataObj).map(([category, val], idx) => ({
    name: category,
